...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="conteudo-principal-escrito">
        <h2 class="conteudo-principal-escrito">Numero total de casos confirmados no Pais: 4,225,396 </h2>
        <h2 class="conteudo-principal-escrito">Numero total de mortes no Pais: 44,067 </h2>
