...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="conteudo-principal-escrito">
        <h2 class="conteudo-principal-escrito">Numero total de casos confirmados no Pais: 34,557,674 </h2>
        <h2 class="conteudo-principal-escrito">Numero total de mortes no Pais: 677,695 </h2>
...
<p>Último acesso ao Pais Brasil em: <span id="data-hora"></span></p>
</footer>
